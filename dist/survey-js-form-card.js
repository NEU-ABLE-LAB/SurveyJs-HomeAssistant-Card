...
class $5b21bedcf572798e$var$SurveyCard extends (0, $ab210b2da7b39b9d$export$3f2f9f5909897157) {
    static{
        this.styles = [
    ...
    setConfig(config) {
        ...
        setTimeout(()=>{
            ...
            if (this._hass?.states[this._config?.state_life_cycle_entity]?.state === "sent" || this._hass?.states[this._config?.state_life_cycle_entity]?.state === "started") // Timer logic
            this.startTimer(this._hass.states[this._config?.state_life_cycle_entity].state);
    ...
    loadSurvey() {
        ...
        const script1Promise = new Promise((resolve)=>{
            ...
            script1.src = "https://unpkg.com/nouislider@14.6.0/distribute/nouislider.min.js";
            script1.defer = true;
        ...
        const script2Promise = new Promise((resolve)=>{
            ...
            script2.src = "https://unpkg.com/surveyjs-widgets@1.9.90/surveyjs-widgets.min.js";
            script2.defer = true;
        ...
        const script3Promise = new Promise((resolve)=>{
            ...
            script3.src = "https://cdnjs.cloudflare.com/ajax/libs/showdown/1.6.4/showdown.min.js";
            script3.defer = true;
    ...
    startTimer(state) {
        ...
        this.survey_timer = setInterval(()=>{
            if (this._hass?.states[this._config?.expiry_timer[0].name].state == "idle") {
    ...
    constructSurveyUI() {
        ...
        this.survey.onComplete.add((sender)=>{
            setTimeout(()=>{
                if (this._config?.floor_plan_location) sender.data.selectedFloorPlan = this._hass.states[this._config?.floor_plan_location]?.state;
                const results = {
...
], $5b21bedcf572798e$var$SurveyCard.prototype, "_config", void 0);
(0, $24c52f343453d62d$export$29e00dfd3077644b)([
    (0, $04c21ea1ce1f6057$export$ca000e230c0caa3e)()
], $5b21bedcf572798e$var$SurveyCard.prototype, "_hass", void 0);
(0, $24c52f343453d62d$export$29e00dfd3077644b)([
    (0, $04c21ea1ce1f6057$export$ca000e230c0caa3e)()
], $5b21bedcf572798e$var$SurveyCard.prototype, "survey", void 0);
(0, $24c52f343453d62d$export$29e00dfd3077644b)([
    (0, $04c21ea1ce1f6057$export$ca000e230c0caa3e)()
], $5b21bedcf572798e$var$SurveyCard.prototype, "survey_timer", void 0);
customElements.define("survey-card", $5b21bedcf572798e$var$SurveyCard);
