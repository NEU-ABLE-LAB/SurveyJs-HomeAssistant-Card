...
})({"7q3Ki":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "1b4567b321f0770e";
"use strict";
  ...
  `
    ...
    setConfig(config) {
        ...
        setTimeout(()=>{
            ...
            if (this._hass?.states[this.config?.state_life_cycle_entity]?.state === "sent" || this._hass?.states[this.config?.state_life_cycle_entity]?.state === "started") // Timer logic
            this.startTimer(this._hass.states[this.config?.state_life_cycle_entity].state);
            else clearInterval(this.survey_timer);
        }, 500);
    }
    // Hass setter
    set hass(hass) {
    ...
    firstUpdated() {
        ...
        (0, _jqueryDefault.default)(document).ready(function() {
            ...
            (0, _jqueryDefault.default).getScript("https://unpkg.com/nouislider/dist/nouislider.min.js");
            (0, _jqueryDefault.default).getScript("https://unpkg.com/survey-jquery/survey.jquery.min.js").done((_script, _textStatus)=>{
                thisNode.constructSurveyUI();
            });
            (0, _jqueryDefault.default).getScript("https://unpkg.com/surveyjs-widgets@1.9.90/surveyjs-widgets.min.js");
            (0, _jqueryDefault.default).getScript("https://cdnjs.cloudflare.com/ajax/libs/showdown/1.6.4/showdown.min.js");
        });
    }
    ...
    async getCustomCss() {
        ...
        if (customCss && noUiSliderStyles && globalCss) {
            ...
            this.customCss = await require(this.config?.customCss + "?" + Math.random());
            this.noUiSliderStyles = await require(this.config?.noUiSliderStyles + "?" + Math.random());
            this.globalCss = await require(this.config?.globalCss + "?" + Math.random());
            ...
            appendStyle.innerHTML = this.noUiSliderStyles?.default + " " + this.globalCss?.default;
    ...
    constructSurveyUI() {
        ...
        this.survey.onComplete.add((sender)=>{
            setTimeout(()=>{
                if (this.config?.floor_plan_location) sender.data.selectedFloorPlan = this._hass.states[this.config?.floor_plan_location]?.state;
                const results = {
        ...
        (0, _jqueryDefault.default)(this.shadowRoot.getElementById("surveyElement")).Survey({
            model: this.survey
        });
    }
    ...
    pageCssLogic(options) {
        let elementsData;
        if (this.config.surveyjs_json?.elements) elementsData = this.config.surveyjs_json?.elements;
        else elementsData = this.config.surveyjs_json?.pages[this.survey?.currentPageNo]?.elements;
...
},{"lit-element":"kvK5P","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kvK5P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@lit/reactive-element":"hypet","lit-html":"1cmQt","./lit-element.js":"9YxkX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hypet":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@lit/reactive-element":"hypet","lit-html":"1cmQt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}]},["7q3Ki","a2J0g"], "a2J0g", "parcelRequire660f")
